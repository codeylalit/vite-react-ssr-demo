import { BharaReasonUseCases as useCases } from '../data/BharaReason';
const BharaReasonUseCase = () => {
  return (
    <>
      {/* Use Cases */}
                ...
                <tbody className="divide-y divide-border">
                  {useCases.map((useCase, index) => (
                    <tr key={index} className="hover:bg-blue-50 transition-colors">
                      ...
                      <td className="p-3 md:px-8 md:py-6">
                        <p className="md:text-lg text-muted-foreground">{useCase.useCase}</p>
                      </td>
                    </tr>
                  ))}
                </tbody>
...
export default BharaReasonUseCase;
